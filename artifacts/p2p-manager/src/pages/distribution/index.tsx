...
import { Plus, Trash2, Calculator, Save, Download, CheckCircle2 } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="glass-panel p-6 rounded-2xl space-y-6">
                ...
                {participantes.map((p, idx) => (
                  <div key={p.id} className="flex items-center gap-2 bg-white/5 p-2 rounded-xl border border-white/5">
                    ...
                    <input 
                      ...
                      onChange={e => {
                        const newP = [...participantes];
                        newP[idx].capital = Number(e.target.value);
                        setParticipantes(newP);
                      }}
                      placeholder="Capital"
                    ...
                    <label className="flex items-center justify-center w-8" title="Es Operador">
                      <input 
                        ...
                        onChange={e => {
                          const newP = [...participantes];
                          newP[idx].esOperador = e.target.checked;
                          setParticipantes(newP);
                        }}
            ...
            <button
              ...
              className="w-full bg-secondary hover:bg-secondary/80 text-foreground font-medium py-3 rounded-xl transition-all flex justify-center items-center gap-2"
            >
        ...
        <div className="lg:col-span-7 space-y-6">
          {resultado ? (
            ...
            <div className="glass-panel p-12 rounded-2xl flex flex-col items-center justify-center text-center border-dashed border-2 h-full">
              ...
              <div className="space-y-3">
                {reports.map(r => (
                  <div key={r.id} className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
                    ...
                    <button className="p-2 bg-secondary text-foreground hover:bg-secondary/80 rounded-lg transition-colors">
